  ...
  return <PublicSiteLayout garage={homepage.garage}>
    <main className="overflow-hidden pb-24 md:pb-10">
      <section className="relative isolate min-h-[560px] md:min-h-[620px] lg:min-h-[660px]">
        ...
        <div className={`${motion.reveal} mx-auto flex min-h-[560px] max-w-7xl flex-col justify-center px-5 py-20 md:min-h-[620px] md:px-8 lg:min-h-[660px]`}>
          <div className="max-w-4xl text-[var(--live-hero-foreground)]">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              {homepage.contact.phone ? <a href={homepage.contact.phone.href} className="inline-flex min-h-12 items-center rounded-xl border border-[var(--live-hero-foreground)]/40 px-5 py-3 font-semibold text-[var(--live-hero-foreground)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--live-focus-ring)]">{homepage.contact.phone.label}</a> : null}
            </div>
          </div>
