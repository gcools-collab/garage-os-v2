...
export function PremiumHomepage({ homepage }: { readonly homepage: PremiumHomepageViewModel }) {
  ...
  const mapHref = homepage.contact.address ? `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(homepage.contact.address)}` : null
