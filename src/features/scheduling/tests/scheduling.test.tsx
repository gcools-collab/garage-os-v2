...
test("builders agenda dashboard public préparent la présentation",()=>{const row={id:"a",garage_id:"g",lead_id:"l",vehicle_id:"v",type:"TEST_DRIVE",status:"PENDING",starts_at:"2026-08-17T09:00:00Z",ends_at:"2026-08-17T09:30:00Z",timezone:"Europe/Paris",customer_name:"Jean Martin",customer_phone:"0600000000",customer_email:null,is_historical:false,payment_required:false,details:{},created_at:"2026-08-16T00:00:00Z"}as const satisfies AppointmentRecord;assert.equal(new AppointmentCalendarBuilder().build([row])[0].href,"/appointments/a");const slots=new PublicBookingBuilder().build([{starts_at:row.starts_at,ends_at:row.ends_at,local_date:"2026-08-17",local_time:"11:00:00"}]);assert.match(renderToStaticMarkup(<PublicSlotSelector slots={slots}/>),/appointmentStartsAt|Choisissez votre rendez-vous/)})
