...
export function PublicContactPage({ contact, request, unavailableRequest = false, missingVehicleRequest = false }: {
  ...
  readonly request?: { readonly form: PublicRequestFormViewModel; readonly vehicleSlug: string | null; readonly vehicleContext: PublicVehicleContextViewModel | null; readonly source: PublicRequestSource; readonly availability: readonly AvailabilitySlot[] } | null
