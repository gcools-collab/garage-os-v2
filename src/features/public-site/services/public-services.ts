...
const definitions: Readonly<Record<PublicServiceId, Omit<PublicServiceViewModel, "href">>> = {
  ...
  REGISTRATION: { id: "REGISTRATION", title: "Démarches d’immatriculation", description: "Carte grise, cession, changement d’adresse, duplicata après perte, fiche d’identification, première immatriculation française, WW provisoire, déclaration d’achat professionnelle et plaques.", actionLabel: "Effectuer une démarche d’immatriculation", icon: "FILE" },
  ENGINE_CLEANING: { id: "ENGINE_CLEANING", title: "Décalaminage moteur", description: "Nettoyage préventif du moteur, avec un diagnostic électronique proposé en complément.", actionLabel: "Prendre rendez-vous", icon: "ENGINE" },
