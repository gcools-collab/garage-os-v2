...
const definitions: Readonly<Record<PublicServiceId, Omit<PublicServiceViewModel, "href">>> = {
  ...
  REGISTRATION: { id: "REGISTRATION", title: "Démarches d’immatriculation", description: "Carte grise, cession, changement d’adresse, duplicata après perte, fiche d’identification, première immatriculation française, WW provisoire, déclaration d’achat professionnelle et plaques.", actionLabel: "Demander une immatriculation", icon: "FILE" },
  ENGINE_CLEANING: { id: "ENGINE_CLEANING", title: "Décalaminage moteur", description: "Nettoyage préventif du moteur, avec option de diagnostic électronique : passage de la valise, lecture des défauts et voyants, effacement lorsque cela est possible, et remise d’un rapport. Un défaut ne peut pas toujours être effacé.", actionLabel: "Prendre rendez-vous", icon: "ENGINE" },
