...
export const LIVE_THEME_REGISTRY: Readonly<Record<LiveThemeKey, LiveThemeDefinition>> = {
  default: {
    ...
    tokens: {
      ...
      focusRing: "#44546A", overlay: "rgba(10, 12, 16, 0.72)", heroForeground: "#FFFFFF", shadowColor: "rgba(20, 24, 31, 0.16)",
    },
  ...
  "black-yellow": {
    ...
    tokens: {
      ...
      focusRing: "#F2C811", overlay: "rgba(0, 0, 0, 0.78)", heroForeground: "#FFFFFF", shadowColor: "rgba(0, 0, 0, 0.52)",
    },
  ...
  midnight: {
    ...
    tokens: {
      ...
      focusRing: "#6CB6FF", overlay: "rgba(2, 8, 18, 0.78)", heroForeground: "#FFFFFF", shadowColor: "rgba(0, 5, 14, 0.55)",
    },
  ...
  "light-premium": {
    ...
    tokens: {
      ...
      focusRing: "#8A6A3D", overlay: "rgba(26, 22, 17, 0.70)", heroForeground: "#FFFFFF", shadowColor: "rgba(45, 38, 28, 0.14)",
    },
  ...
  "sport-red": {
    ...
    tokens: {
      ...
      focusRing: "#F06468", overlay: "rgba(3, 4, 6, 0.78)", heroForeground: "#FFFFFF", shadowColor: "rgba(0, 0, 0, 0.5)",
    },
